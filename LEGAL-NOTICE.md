...
**The game is not ours.** *Hole in One Professional* was published by **HAL Laboratory** for the
MSX in 1986, in a 32 KB cartridge. All rights over the game remain with their
holders.
...
The file `src/holeinonepro.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Hole in One Professional* or hold rights over the game, and you would rather this
